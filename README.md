...
- 由于喜马拉雅官方的限制，理论上付费音频的下载接口每日只能调用不到1000次，所以如果提示今日下载次数已达上限，请明天再试。但是经过测试，快速地发送大量请求好像可以突破这个限制，所以使用我的程序一次下载一个专辑里的一两千个音频应该是没有问题的。这个问题我暂时还没有找到解决方法，如果有大佬知道的话，欢迎提交pr或issue。
